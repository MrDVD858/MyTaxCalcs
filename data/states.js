const states = [
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Arizona has a flat state income tax rate of 2.5% on all taxable income as of 2023, following the passage of Proposition 132. This replaced the previous graduated bracket system and makes Arizona one of the simpler states for income tax calculation. The standard deduction for Arizona residents is slug: "arizona", hasIncomeTax: true,
    topRate: 2.5, bottomRate: 2.5, brackets: "2.5% flat",
    note: "Arizona uses a flat income tax rate of 2.5% for all taxpayers, one of the lowest flat rates in the country.",
    noTaxNote: null3,850 for single filers and 
  }7,700 for married couples filing jointly. Arizona also allows personal exemptions and a range of deductions and credits, including for dependents and charitable contributions made to qualifying organizations in the state."
  },
  {
    ...
    noTaxNote: null,
    overview: "Arkansas uses a graduated income tax system with rates ranging from 2% to 4.4% for most filers in 2025, following a series of tax cuts enacted in recent years. The top marginal rate applies to income above $89,600. Arkansas offers a low-income tax credit for residents earning below certain thresholds, and the state allows deductions for federal income taxes paid, which can reduce Arkansas taxable income for many filers. The standard deduction in Arkansas is 
  },200 for single filers and $4,400 for married couples filing jointly."
  },
  {
    ...
    noTaxNote: null,
    overview: "California has the highest top marginal state income tax rate in the country at 13.3%, which applies to income above slug: "california", hasIncomeTax: true,
    topRate: 13.3, bottomRate: 1.0, brackets: "1%–13.3%",
    note: "California has the highest top marginal income tax rate in the country at 13.3%. It uses a graduated rate system with 9 brackets.",
    noTaxNote: null million for single filers. The state uses a graduated system with nine brackets ranging from 1% to 13.3%. Single filers begin paying tax at 1% on income up to slug: "california", hasIncomeTax: true,
    topRate: 13.3, bottomRate: 1.0, brackets: "1%–13.3%",
    note: "California has the highest top marginal income tax rate in the country at 13.3%. It uses a graduated rate system with 9 brackets.",
    noTaxNote: null0,756 and reach the 9.3% bracket at income above $67,149. California's standard deduction is notably low — just $5,202 for single filers and slug: "california", hasIncomeTax: true,
    topRate: 13.3, bottomRate: 1.0, brackets: "1%–13.3%",
    note: "California has the highest top marginal income tax rate in the country at 13.3%. It uses a graduated rate system with 9 brackets.",
    noTaxNote: null0,404 for married couples — meaning most residents pay state income tax on a larger portion of their earnings than in states with higher deductions."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Delaware imposes a graduated state income tax with six brackets ranging from 0% to 6.6%. Income up to 
  },000 is exempt, and the top rate of 6.6% applies to income above $60,000. Delaware is known as a tax-friendly state for retirees — there is no sales tax statewide, and the state offers a significant pension exclusion of up to slug: "delaware", hasIncomeTax: true,
    topRate: 6.6, bottomRate: 2.2, brackets: "2.2%–6.6%",
    note: "Delaware has a graduated income tax with rates from 2.2% to 6.6%. Delaware has no state sales tax.",
    noTaxNote: null2,500 for residents 60 and older. The standard deduction is $3,250 for single filers and $6,500 for married couples filing jointly. Delaware also allows a personal credit of slug: "delaware", hasIncomeTax: true,
    topRate: 6.6, bottomRate: 2.2, brackets: "2.2%–6.6%",
    note: "Delaware has a graduated income tax with rates from 2.2% to 6.6%. Delaware has no state sales tax.",
    noTaxNote: null10 per exemption claimed."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Georgia uses a flat income tax rate of 5.49% for 2024, with the rate scheduled to gradually decrease to 4.99% over time under legislation enacted in recent years. Georgia allows a standard deduction of $5,400 for single filers and $7,100 for married couples filing jointly. The state also provides a personal exemption of 
  },700 per person and a $3,000 exemption per dependent. Georgia taxes most retirement income but offers a retirement income exclusion of up to $65,000 per person for residents 65 and older, making it increasingly attractive for retirees."
  },
  {
    ...
    noTaxNote: null,
    overview: "Hawaii has the highest top marginal state income tax rate among all states at 11%, which applies to income above 
  }00,000 for single filers. Hawaii uses a graduated system with twelve brackets beginning at 1.4% on income up to 
  },400. The standard deduction in Hawaii is 
  },200 for single filers and $4,400 for married couples — among the lowest in the country. Hawaii does not conform to many federal tax provisions, so residents must recalculate certain items under state rules. Hawaii also imposes a General Excise Tax in lieu of a traditional sales tax, which is effectively passed on to consumers at rates ranging from 4% to 4.5%."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Indiana uses a flat state income tax rate of 3.05% for 2024, with reductions scheduled in future years as part of ongoing tax reform legislation. Indiana also allows county income taxes, which vary by county and generally range from 0.5% to 3.38%, meaning your total Indiana income tax rate depends on where you live. Indiana provides a slug: "indiana", hasIncomeTax: true,
    topRate: 3.05, bottomRate: 3.05, brackets: "3.05% flat",
    note: "Indiana uses a flat income tax rate of 3.05%. Counties in Indiana may also levy local income taxes.",
    noTaxNote: null,000 personal exemption per taxpayer and an additional exemption for dependents. The state also offers a slug: "indiana", hasIncomeTax: true,
    topRate: 3.05, bottomRate: 3.05, brackets: "3.05% flat",
    note: "Indiana uses a flat income tax rate of 3.05%. Counties in Indiana may also levy local income taxes.",
    noTaxNote: null,000 exemption for residents over 65 and for those who are blind or disabled. Indiana generally conforms to federal adjusted gross income with certain modifications."
  },
  {
  ...
  },210 for single filers and $5,450 for married couples filing jointly. Iowa also permits deductions for federal income taxes paid under certain circumstances."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Maine uses a graduated income tax with three brackets for 2025: 5.8% on income up to 
  }4,500 for single filers, 6.75% on income from 
  }4,501 to $58,050, and 7.15% on income above $58,050. Maine provides a standard deduction equal to the federal standard deduction and conforms closely to federal definitions of income and deductions. The state offers a property tax fairness credit for lower- and moderate-income residents and a sales tax fairness credit as well. Maine partially taxes Social Security benefits using the same method as the federal government, but offers an exemption for lower-income retirees."
  },
  {
    ...
    noTaxNote: null,
    overview: "Maryland has a graduated state income tax with eight brackets ranging from 2% to 5.75%, plus an additional 1.75% surtax on income above slug: "maryland", hasIncomeTax: true,
    topRate: 5.75, bottomRate: 2.0, brackets: "2%–5.75%",
    note: "Maryland has a graduated income tax with rates from 2% to 5.75%. Maryland counties also levy local income taxes.",
    noTaxNote: null00,000 for single filers. Beyond state income tax, Maryland counties and Baltimore City each impose a local income tax ranging from 2.25% to 3.2%, making Maryland's combined state and local income tax one of the higher burdens in the country. Maryland provides a standard deduction of 15% of adjusted gross income, with a minimum of slug: "maryland", hasIncomeTax: true,
    topRate: 5.75, bottomRate: 2.0, brackets: "2%–5.75%",
    note: "Maryland has a graduated income tax with rates from 2% to 5.75%. Maryland counties also levy local income taxes.",
    noTaxNote: null,700 and a maximum of 
  },550 for single filers. The state exempts the first $35,000 of military retirement pay for qualifying residents."
  },
  {
    ...
    noTaxNote: null,
    overview: "Massachusetts imposes a flat income tax rate of 5% on most income, with a higher surtax of 4% on income above slug: "massachusetts", hasIncomeTax: true,
    topRate: 9.0, bottomRate: 5.0, brackets: "5%–9%",
    note: "Massachusetts has a flat 5% income tax rate for most income, with a 9% surtax on income over $1 million.",
    noTaxNote: null million, making the effective top rate 9% for very high earners under the Fair Share Amendment passed in 2022. Massachusetts taxes most income at the flat rate, including wages, interest, dividends, and long-term capital gains. Short-term capital gains are taxed at 8.5%. Massachusetts allows a personal exemption of $4,400 for single filers and $8,800 for married couples. The state does not tax Social Security benefits, and certain pension income for state and municipal employees is exempt."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Mississippi has a flat income tax rate of 4.7% for 2024, reduced from 5% as part of a phased tax cut that will lower the rate to 4% by 2026. The state provides a standard deduction of 
  },300 for single filers and $4,600 for married couples filing jointly, plus a personal exemption of $6,000 for single filers and slug: "mississippi", hasIncomeTax: true,
    topRate: 4.7, bottomRate: 4.7, brackets: "4.7% flat",
    note: "Mississippi uses a flat income tax rate of 4.7% and plans to phase it out completely by 2030.",
    noTaxNote: null2,000 for married couples. Mississippi fully exempts Social Security income, most retirement income including public and private pensions, and military retirement pay from state income tax. Mississippi's relatively low cost of living and modest tax burden make it an attractive state for retirees on fixed incomes."
  },
  {
    ...
    noTaxNote: null,
    overview: "Missouri uses a graduated income tax system with rates starting at 2% and reaching a top rate of 4.8% for 2024 on income above $9,000, following a series of phased tax reductions. Missouri allows a deduction for federal income taxes paid, up to $5,000 for single filers and slug: "missouri", hasIncomeTax: true,
    topRate: 4.7, bottomRate: 2.0, brackets: "2%–4.7%",
    note: "Missouri has a graduated income tax with rates from 2% to 4.7% and has been reducing its top rate.",
    noTaxNote: null0,000 for married couples, which can meaningfully reduce state taxable income. The state provides a standard deduction equal to the federal standard deduction. Missouri fully exempts Social Security benefits and 100% of public pension income for qualifying retirees. Military retirement pay is also fully exempt from Missouri state income tax."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "New Jersey has a graduated income tax with seven brackets ranging from 1.4% to 10.75% for 2025. Single filers pay 1.4% on income up to 
  }0,000 and enter the top 10.75% bracket on income above slug: "new-jersey", hasIncomeTax: true,
    topRate: 10.75, bottomRate: 1.4, brackets: "1.4%–10.75%",
    note: "New Jersey has a graduated income tax with rates from 1.4% to 10.75% across 7 brackets.",
    noTaxNote: null million. New Jersey provides a property tax credit of up to slug: "new-jersey", hasIncomeTax: true,
    topRate: 10.75, bottomRate: 1.4, brackets: "1.4%–10.75%",
    note: "New Jersey has a graduated income tax with rates from 1.4% to 10.75% across 7 brackets.",
    noTaxNote: null,500 for homeowners and renters, and exempts Social Security and Railroad Retirement benefits from state income tax. The state does not provide a standard deduction for single filers, but does offer personal exemptions and various credits. New Jersey's high property taxes and relatively high income tax rates make it one of the higher overall tax burden states in the country."
  },
  {
    ...
    noTaxNote: null,
    overview: "New Mexico uses a graduated income tax with five brackets ranging from 1.7% to 5.9% for 2024. Single filers reach the top rate on income above slug: "new-mexico", hasIncomeTax: true,
    topRate: 5.9, bottomRate: 1.7, brackets: "1.7%–5.9%",
    note: "New Mexico has a graduated income tax with rates from 1.7% to 5.9% across 5 brackets.",
    noTaxNote: null57,000. New Mexico provides a standard deduction equal to the federal standard deduction and conforms broadly to federal income definitions. Social Security benefits are generally exempt from New Mexico income tax for residents with income below slug: "new-mexico", hasIncomeTax: true,
    topRate: 5.9, bottomRate: 1.7, brackets: "1.7%–5.9%",
    note: "New Mexico has a graduated income tax with rates from 1.7% to 5.9% across 5 brackets.",
    noTaxNote: null00,000 for single filers and slug: "new-mexico", hasIncomeTax: true,
    topRate: 5.9, bottomRate: 1.7, brackets: "1.7%–5.9%",
    note: "New Mexico has a graduated income tax with rates from 1.7% to 5.9% across 5 brackets.",
    noTaxNote: null50,000 for married couples. New Mexico also offers a low-income comprehensive tax rebate and a working families tax credit modeled on the federal Earned Income Tax Credit."
  },
  {
    ...
    noTaxNote: null,
    overview: "New York has a graduated state income tax with nine brackets ranging from 4% to 10.9% for 2024. Single filers begin paying at 4% on income up to $8,500 and reach the top 10.9% bracket on income above 
  }5 million. New York City residents pay an additional city income tax of 3.078% to 3.876%, and Yonkers adds a surcharge as well, making New York one of the highest combined income tax burden states in the country. New York provides a standard deduction of $8,000 for single filers and slug: "new-york", hasIncomeTax: true,
    topRate: 10.9, bottomRate: 4.0, brackets: "4%–10.9%",
    note: "New York has a graduated income tax with rates from 4% to 10.9%. New York City residents also pay a separate city income tax.",
    noTaxNote: null6,050 for married couples. Social Security income is fully exempt, and there is a pension exclusion of up to 
  }0,000 for qualifying retirees."
  },
  {
    ...
    noTaxNote: null,
    overview: "North Carolina has a flat state income tax rate of 4.5% for 2024, reduced from 4.75% as part of ongoing legislation that will lower the rate to 3.99% by 2026. North Carolina provides a standard deduction of slug: "north-carolina", hasIncomeTax: true,
    topRate: 4.5, bottomRate: 4.5, brackets: "4.5% flat",
    note: "North Carolina uses a flat income tax rate of 4.5% and has been gradually reducing it.",
    noTaxNote: null0,750 for single filers and 
  }1,500 for married couples filing jointly. The state taxes most retirement income but exempts Social Security benefits and provides a $4,000 exclusion for other qualifying retirement income. North Carolina does not allow a deduction for federal income taxes paid. The state's flat tax and increasing standard deduction make it relatively straightforward for most residents to estimate their state income tax liability."
  },
  {
    ...
    noTaxNote: null,
    overview: "North Dakota uses a graduated income tax with five brackets ranging from 1.1% to 2.5% for 2024, making it one of the lowest-tax states for income. Single filers reach the top 2.5% rate on income above 
  }25,000. North Dakota provides a standard deduction equal to the federal standard deduction and conforms closely to federal income definitions. The state exempts Social Security income from state income tax and offers a credit for income taxes paid to other states. North Dakota also provides an exemption for military retirement pay and an incentive for residents who serve in the National Guard."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Oklahoma imposes a graduated income tax with five brackets ranging from 0.25% to 4.75% for 2024. Single filers pay the top rate on income above $7,200. Oklahoma provides a standard deduction of $6,350 for single filers and slug: "oklahoma", hasIncomeTax: true,
    topRate: 4.75, bottomRate: 0.25, brackets: "0.25%–4.75%",
    note: "Oklahoma has a graduated income tax with rates from 0.25% to 4.75% across 6 brackets.",
    noTaxNote: null2,700 for married couples filing jointly. The state offers a credit for income taxes paid to other states and provides an exemption for Social Security income, military retirement pay, and a portion of other retirement income. Oklahoma also allows a deduction for contributions to the state's 529 college savings plan."
  },
  {
    ...
    noTaxNote: null,
    overview: "Oregon has a graduated state income tax with four brackets ranging from 4.75% to 9.9% for 2024. Single filers pay 4.75% on income up to slug: "oregon", hasIncomeTax: true,
    topRate: 9.9, bottomRate: 4.75, brackets: "4.75%–9.9%",
    note: "Oregon has a graduated income tax with rates from 4.75% to 9.9%. Oregon has no state sales tax.",
    noTaxNote: null8,400 and reach the top 9.9% rate on income above 
  }50,000. Portland and surrounding Multnomah County impose additional local income taxes, including a Metro Supportive Housing Services Tax and a Preschool for All Tax on income above certain thresholds. Oregon does not have a state sales tax. The state provides a standard deduction of 
  },420 for single filers and $4,865 for married couples. Oregon fully taxes Social Security income but allows a credit for lower-income seniors."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Rhode Island uses a graduated income tax with three brackets ranging from 3.75% to 5.99% for 2024. Single filers pay 3.75% on income up to $73,450, 4.75% on income from $73,451 to slug: "rhode-island", hasIncomeTax: true,
    topRate: 5.99, bottomRate: 3.75, brackets: "3.75%–5.99%",
    note: "Rhode Island has a graduated income tax with rates from 3.75% to 5.99% across 3 brackets.",
    noTaxNote: null66,950, and 5.99% on income above slug: "rhode-island", hasIncomeTax: true,
    topRate: 5.99, bottomRate: 3.75, brackets: "3.75%–5.99%",
    note: "Rhode Island has a graduated income tax with rates from 3.75% to 5.99% across 3 brackets.",
    noTaxNote: null66,950. Rhode Island provides a standard deduction of slug: "rhode-island", hasIncomeTax: true,
    topRate: 5.99, bottomRate: 3.75, brackets: "3.75%–5.99%",
    note: "Rhode Island has a graduated income tax with rates from 3.75% to 5.99% across 3 brackets.",
    noTaxNote: null0,550 for single filers and 
  }1,150 for married couples, and also allows a personal exemption credit of $500 per exemption, which phases out at higher incomes. The state taxes Social Security income for residents above certain income thresholds. Rhode Island offers a property tax relief credit for qualifying lower-income homeowners and renters."
  },
  {
    ...
    noTaxNote: null,
    overview: "South Carolina uses a graduated income tax system with a top rate of 6.4% for 2024, scheduled to continue declining in future years. The state provides a deduction of 44% of net capital gains from its income tax, making it attractive for investors. South Carolina allows a standard deduction of slug: "south-carolina", hasIncomeTax: true,
    topRate: 6.2, bottomRate: 3.0, brackets: "3%–6.2%",
    note: "South Carolina has a graduated income tax with rates from 3% to 6.2% and has been reducing its top rate.",
    noTaxNote: null3,850 for single filers and 
  }7,700 for married couples. The state fully exempts Social Security income and offers a retirement income deduction of up to slug: "south-carolina", hasIncomeTax: true,
    topRate: 6.2, bottomRate: 3.0, brackets: "3%–6.2%",
    note: "South Carolina has a graduated income tax with rates from 3% to 6.2% and has been reducing its top rate.",
    noTaxNote: null0,000 for residents 65 and older. Military retirement pay is fully exempt from South Carolina state income tax."
  },
  {
  ...
  },
  {
    ...
    noTaxNote: null,
    overview: "Virginia uses a graduated income tax with four brackets ranging from 2% to 5.75% for 2024. Single filers pay 2% on income up to $3,000 and reach the top 5.75% rate on income above slug: "virginia", hasIncomeTax: true,
    topRate: 5.75, bottomRate: 2.0, brackets: "2%–5.75%",
    note: "Virginia has a graduated income tax with rates from 2% to 5.75% across 4 brackets.",
    noTaxNote: null7,000. Virginia has not indexed its brackets for inflation, so most taxpayers fall into the top bracket relatively quickly. The state provides a standard deduction of $8,000 for single filers and slug: "virginia", hasIncomeTax: true,
    topRate: 5.75, bottomRate: 2.0, brackets: "2%–5.75%",
    note: "Virginia has a graduated income tax with rates from 2% to 5.75% across 4 brackets.",
    noTaxNote: null6,000 for married couples, significantly increased in recent years. Virginia exempts Social Security income from state tax and provides an age deduction of slug: "virginia", hasIncomeTax: true,
    topRate: 5.75, bottomRate: 2.0, brackets: "2%–5.75%",
    note: "Virginia has a graduated income tax with rates from 2% to 5.75% across 4 brackets.",
    noTaxNote: null2,000 for residents 65 and older with income below certain thresholds. Military pay earned by active duty members stationed outside Virginia is exempt."
  },
  {
    ...
    overview: "Washington State has no state income tax on wages, salaries, or most personal income. Washington does impose a 7% capital gains tax on the sale of long-term capital assets exceeding 
  }50,000 per year, upheld by the Washington Supreme Court in 2023. The state funds its government primarily through a 6.5% state sales tax, with local additions bringing combined rates as high as 10.4% in some areas. Washington also imposes a Business and Occupation tax on business gross receipts. Washington residents owe federal income tax on all taxable income. The absence of a broad-based income tax makes Washington attractive for high earners, though the sales tax burden is notable."
  },
  {
    ...
    noTaxNote: null,
    overview: "West Virginia uses a graduated income tax with five brackets ranging from 2.36% to 5.12% for 2024, following recent rate reductions. The state is phasing in further tax cuts and may move toward a flat or reduced rate structure in coming years. West Virginia provides a standard deduction of 
  }0,000 for single filers and 
  }0,000 for married couples. The state fully exempts Social Security income from state income tax and provides a significant exemption for military retirement pay and certain public pension income. West Virginia taxes most other retirement income, and the state also offers a credit for income taxes paid to other states."
  },
  {
    ...
    noTaxNote: null,
    overview: "Wisconsin uses a graduated income tax with four brackets ranging from 3.5% to 7.65% for 2024. Single filers pay 3.5% on income up to slug: "wisconsin", hasIncomeTax: true,
    topRate: 7.65, bottomRate: 3.54, brackets: "3.54%–7.65%",
    note: "Wisconsin has a graduated income tax with rates from 3.54% to 7.65% across 4 brackets.",
    noTaxNote: null3,810 and reach the top 7.65% rate on income above $304,170. Wisconsin provides a standard deduction that phases out at higher income levels — slug: "wisconsin", hasIncomeTax: true,
    topRate: 7.65, bottomRate: 3.54, brackets: "3.54%–7.65%",
    note: "Wisconsin has a graduated income tax with rates from 3.54% to 7.65% across 4 brackets.",
    noTaxNote: null2,110 for single filers with income below slug: "wisconsin", hasIncomeTax: true,
    topRate: 7.65, bottomRate: 3.54, brackets: "3.54%–7.65%",
    note: "Wisconsin has a graduated income tax with rates from 3.54% to 7.65% across 4 brackets.",
    noTaxNote: null6,000, phasing to zero above slug: "wisconsin", hasIncomeTax: true,
    topRate: 7.65, bottomRate: 3.54, brackets: "3.54%–7.65%",
    note: "Wisconsin has a graduated income tax with rates from 3.54% to 7.65% across 4 brackets.",
    noTaxNote: null10,770. The state taxes Social Security income but provides a partial subtraction for lower-income retirees. Wisconsin allows a deduction for contributions to Wisconsin 529 college savings accounts and offers a homestead credit for lower-income residents who own or rent their home."
  },
  {
